...
cluster = {
  ...
  storage_data_vlan_name        = "HX-STR-DATA-103"
  storage_data_vlan_id          = 103
  # storage_cluster_auxiliary_ip  = ""
  # storage_type                  = "" # HyperFlexDp, ThirdParty
  # wwxn_prefix                   = ""

  ### IWE HYPERVISOR ONLY ###
  storage_client_vlan_name      = "HX-STR-CLIENT-104"
  storage_client_vlan_id        = 104
  storage_client_ip_address     = "172.31.255.2"
  storage_client_netmask        = "255.255.255.0"
